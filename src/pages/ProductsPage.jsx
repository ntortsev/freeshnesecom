...
import { Header, Footer, Menu, ProductCard, Categories, PriceBlock } from "../components/index";

function ProductsPage({ categories, products, changeCategory, changeRangePrice }) {
  return (
